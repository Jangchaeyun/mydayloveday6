...
import com.myday.response.ApiResponse;
import com.myday.service.PostService;
...
public class PostController {
	...
	public ResponseEntity<Post> findPostHandler(@PathVariable Integer postId) throws Exception {
